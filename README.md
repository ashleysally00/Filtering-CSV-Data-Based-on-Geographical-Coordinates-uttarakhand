...
I interviewed a wildfire Public Information Officer in Redding, California, to get background information on what types of data it would be most useful to collect when working to create a ML wildfire prediction tool using AI, *subject: wildfire spread*
